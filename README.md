...
## 3.1.0 ##
- [methodDefaultParameters] Method default parameter using an overloaded method(https://github.com/AntoniRokitnicki/AdvancedExpressionFolding/wiki/MethodDefaultParameters)
