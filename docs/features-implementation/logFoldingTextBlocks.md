---
title: Log Folding Text Blocks (State field: logFoldingTextBlocks)
option: logFoldingTextBlocks
source: wiki-clone/docs/features/logFoldingTextBlocks.md
---
...
- Defined in `src/com/intellij/advancedExpressionFolding/settings/AdvancedExpressionFoldingSettings.kt:71` with default `true`.
- Defined in `src/com/intellij/advancedExpressionFolding/settings/LogFoldingState.kt:10` with default `true`.
