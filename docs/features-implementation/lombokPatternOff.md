---
title: Lombok Pattern Off (State field: lombokPatternOff)
option: lombokPatternOff
source: wiki-clone/docs/features/lombokPatternOff.md
---
...
- `src/com/intellij/advancedExpressionFolding/processor/lombok/AnnotationExt.kt:6` – `import com.intellij.advancedExpressionFolding.processor.lombok.LombokExt.lombokPatternOff`
- `src/com/intellij/advancedExpressionFolding/processor/lombok/AnnotationExt.kt:26` – `lombokPatternOff?.run {`
- `src/com/intellij/advancedExpressionFolding/processor/lombok/AnnotationExt.kt:61` – `if (PATTERN_CACHE?.toString() != lombokPatternOff) {`
- `src/com/intellij/advancedExpressionFolding/processor/lombok/AnnotationExt.kt:62` – `PATTERN_CACHE = lombokPatternOff?.toRegex()`

## Default Configuration

- Defined in `src/com/intellij/advancedExpressionFolding/settings/AdvancedExpressionFoldingSettings.kt:92` with default `null`.
- Defined in `src/com/intellij/advancedExpressionFolding/settings/LombokState.kt:14` with default `null`.

### Settings UI Registration

- `src/com/intellij/advancedExpressionFolding/settings/view/CheckboxesProvider.kt:214` – `cell(createEditor(state::lombokPatternOff).component)`
...
- `test/com/intellij/advancedExpressionFolding/folding/base/folding/LombokFoldingTest.kt:30` – `fun lombokPatternOffTestData() {`
- `test/com/intellij/advancedExpressionFolding/folding/base/folding/LombokFoldingTest.kt:32` – `state.lombokPatternOff = "LombokPa[t]{2}ernOffTestData"`
- `test/com/intellij/advancedExpressionFolding/folding/base/folding/LombokFoldingTest.kt:36` – `state.lombokPatternOff = null`
- `test/com/intellij/advancedExpressionFolding/folding/base/folding/LombokFoldingTest.kt:41` – `fun lombokPatternOffNegativeTestData() {`
- `test/com/intellij/advancedExpressionFolding/folding/base/folding/LombokFoldingTest.kt:43` – `state.lombokPatternOff = "LombokPatternOffTestData"`
- `test/com/intellij/advancedExpressionFolding/folding/base/folding/LombokFoldingTest.kt:47` – `state.lombokPatternOff = null`
