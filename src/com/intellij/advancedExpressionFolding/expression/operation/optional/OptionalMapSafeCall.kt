...
class OptionalMapSafeCall(element: PsiElement, textRange: TextRange, operands: List<Expression>, flatMap: Boolean) : Operation(element, textRange, if (flatMap) "?.*" else "?.", 300, operands) {
