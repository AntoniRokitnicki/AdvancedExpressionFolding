...
abstract class CheckboxesProvider {
    ...
    fun Panel.initialize(state: State) {
        collapsibleGroup("Core expression folding") {
        ...
        collapsibleGroup("Dates and time") {
        ...
        collapsibleGroup("Null safety and control flow") {
            registerCheckbox(
        ...
        collapsibleGroup("Collections, streams and logging") {
        ...
        collapsibleGroup("Lombok and POJO helpers") {
        ...
        collapsibleGroup("Syntax cleanup and annotations") {
        ...
        collapsibleGroup("Advanced and experimental") {
