...
abstract class CheckboxesProvider {
    ...
    fun Panel.initialize(state: State) {
        collapsibleGroup("Core syntax improvements") {
        ...
        collapsibleGroup("Comparison and date helpers") {
        ...
        collapsibleGroup("Null safety and optionals") {
        ...
        collapsibleGroup("Logging, assertions, and streams") {
        ...
        collapsibleGroup("Convenience helpers") {
            registerCheckbox(
                state::fieldShift,
        ...
        collapsibleGroup("Code style adjustments") {
            registerCheckbox(
        ...
        collapsibleGroup("Annotations and modifiers") {
        ...
        collapsibleGroup("Lombok integration") {
        ...
        collapsibleGroup("Advanced language features") {
        ...
        collapsibleGroup("Performance and experimental") {
