...
import com.intellij.advancedExpressionFolding.expression.ToDegrees
...
class MathToDegreesMethodCall : AbstractMathMethodCall() {
    ...
    ): Expression? = ToDegrees(element, element.textRange, Collections.singletonList(argumentExpression))
}
