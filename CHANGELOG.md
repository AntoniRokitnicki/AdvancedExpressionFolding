...
- [pseudo-annotations] Introduce toggleable **@TracingLoggable** pseudo-annotation that uses XDebugger tracing breakpoints for expression logging, supports grouped breakpoints by annotation and file, and includes full class-level toggling and cleanup logic. See [#447](https://github.com/AntoniRokitnicki/AdvancedExpressionFolding/pull/447), [#448](https://github.com/AntoniRokitnicki/AdvancedExpressionFolding/pull/448).
- [pseudo-annotations] Introduce toggleable **@Loggable** pseudo-annotation to log method entry, exit, parameters, return values, and exceptions for methods or entire classes, with full control-flow analysis and automatic removal of injected statements. See [#441](https://github.com/AntoniRokitnicki/AdvancedExpressionFolding/pull/441), [#429](https://github.com/AntoniRokitnicki/AdvancedExpressionFolding/pull/429), [#431](https://github.com/AntoniRokitnicki/AdvancedExpressionFolding/pull/431), [#363](https://github.com/AntoniRokitnicki/AdvancedExpressionFolding/pull/363).
