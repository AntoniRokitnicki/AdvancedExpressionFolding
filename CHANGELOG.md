...
- [pseudo-annotations] Introduce **@Breakpointable** pseudo-annotation based on @TracingLoggable that creates standard XDebugger line breakpoints instead of tracing breakpoints. It logs nothing directly, ensuring zero runtime overhead while still enabling per-line inspection through grouped class-level toggling. See [#453](https://github.com/AntoniRokitnicki/AdvancedExpressionFolding/pull/453).
