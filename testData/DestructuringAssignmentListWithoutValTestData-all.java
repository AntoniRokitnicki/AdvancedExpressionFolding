...
public class DestructuringAssignmentListWithoutValTestData {
    public void enter(Data data, List<Data> list) <fold text='{...}' expand='true'>{
        ...
        Data<fold text=' (' expand='true'> </fold>first<fold text=', ' expand='false'> = list.get(0);</fold><fold text='' expand='true'>
        ...
        Data<fold text=' (' expand='true'> </fold>getter1<fold text=', ' expand='false'> = data.getList().get(0);</fold><fold text='' expand='true'>
        ...
        Data<fold text=' (' expand='true'> </fold>deepGetter1<fold text=', ' expand='false'> = data.getData().getList().get(0);</fold><fold text='' expand='true'>
