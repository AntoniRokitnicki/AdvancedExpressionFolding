...
public <fold text='🏛️' expand='false'>class</fold> TypeCastTestData {
    ...
    <fold text='🚫' expand='false'>private</fold> <fold text='⚡' expand='false'>static</fold> <fold text='💀' expand='false'>void</fold> handle(TypeCastTestData t)<fold text=' { ' expand='false'> {
