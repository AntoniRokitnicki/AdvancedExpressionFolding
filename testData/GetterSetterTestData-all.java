...
<fold text='@Getter @Setter p' expand='false'>p</fold>ublic <fold text='🏛️' expand='false'>class</fold> GetterSetterTestData {
    ...
    </fold><fold text='🚫' expand='false'><fold text='' expand='false'>private</fold> <fold text='💀' expand='false'>void</fold> setParent(GetterSetterTestData parent)<fold text=' { ' expand='false'> {
        </fold>this.parent = <fold text='<<' expand='false'>parent</fold>;<fold text=' }' expand='false'>
    }</fold><fold text='' expand='false'></fold>

    </fold><fold text='🚫' expand='false'><fold text='' expand='false'>private</fold> GetterSetterTestData getParent()<fold text=' { ' expand='false'> {
        </fold><fold text='🔙' expand='false'>return</fold> parent;<fold text=' }' expand='false'>
    }</fold></fold><fold text='' expand='false'>

    </fold><fold text='🚫' expand='false'><fold text='' expand='false'>private</fold> String getName()<fold text=' { ' expand='false'> {
        </fold><fold text='🔙' expand='false'>return</fold> name;<fold text=' }' expand='false'>
    }</fold></fold><fold text='' expand='false'>

    </fold><fold text='🚫' expand='false'><fold text='' expand='false'>private</fold> <fold text='💀' expand='false'>void</fold> setName(String name)<fold text=' { ' expand='false'> {
