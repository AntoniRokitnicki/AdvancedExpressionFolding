...
public <fold text='🏛️' expand='false'>class</fold> DynamicTestData {
    ...
    <fold text='@Getter s' expand='false'><fold text='⚡' expand='false'>s</fold>tatic</fold> <fold text='🏛️' expand='false'>class</fold> Data <fold text='{...}' expand='true'>{
        ...
        </fold><fold text='' expand='false'>public String getData()<fold text=' { ' expand='false'> {
            </fold><fold text='🔙' expand='false'>return</fold> data;<fold text=' }' expand='false'>
        }</fold></fold>
    }</fold>


    public <fold text='⚡' expand='false'>static</fold> <fold text='💀' expand='false'>void</fold> staticMethod(Data data) <fold text='{...}' expand='true'>{
        new DynamicTestData()
    ...
    <fold text='🚫' expand='false'><fold text='' expand='true'>private</fold> String normalMethod(String args<fold text=' = args.substring(1))' expand='true'>)</fold><fold text=' { ' expand='false'> {
        </fold><fold text='🔙' expand='false'>return</fold> <fold text='changedNormalMethod' expand='true'>normalMethod</fold>(args<fold text='[' expand='false'>.substring(</fold>1<fold text=':]' expand='false'>)</fold>);<fold text=' }' expand='false'>
    }</fold></fold>

    <fold text='🚫' expand='false'>private</fold> <fold text='⚡' expand='false'>static</fold> String staticMethod(String args) <fold text='{...}' expand='true'>{
