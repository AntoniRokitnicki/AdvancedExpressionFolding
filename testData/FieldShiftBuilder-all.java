...
<fold text='@Builder @AllArgsConstructor(default) @Getter p' expand='false'>p</fold>ublic class FieldShiftBuilder {
    ...
    public static BuilderFieldShiftBuilder builder()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
        ...
        </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold><fold text='📍' expand='false'>this</fold>.active<fold text=' ' expand='true'>;</fold><fold text=' }' expand='false'><fold text='' expand='true'>
    </fold>}</fold><fold text='' expand='false'></fold>
    ...
    <fold text='@Builder @AllArgsConstructor(default) @Getter p' expand='false'>p</fold>ublic <fold text='⚡' expand='false'>static</fold> class UserData2 <fold text='{...}' expand='true'>{
        private String username;
        private boolean active;
        ...
        <fold text='@NoArgsConstructor(default) @ToString p' expand='false'>p</fold>ublic <fold text='⚡' expand='false'>static</fold> class UserData2Builder <fold text='{...}' expand='true'>{
            private String username;
            private boolean active;
            private String userIdentifier;<fold text='' expand='false'>
    ...
    <fold text='@NoArgsConstructor(default) @ToString p' expand='false'>p</fold>ublic <fold text='⚡' expand='false'>static</fold> class BuilderFieldShiftBuilder <fold text='{...}' expand='true'>{
        private String username;
        private boolean active;
        private String userIdentifier;
        private FieldShiftBuilder child;<fold text='' expand='false'>
        ...
        public FieldShiftBuilder build()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold><fold text='' expand='true'></fold>return</fold><fold text='' expand='true'> </fold>new FieldShiftBuilder(username, active, userIdentifier, child)<fold text=' ' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold><fold text='' expand='false'>
