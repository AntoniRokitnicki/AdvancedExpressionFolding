...
<fold text='@Builder(BuilderFieldShiftBuilder) @AllArgsConstructor(default) @Getter p' expand='false'>p</fold>ublic <fold text='🏛️' expand='false'>class</fold> FieldShiftBuilder {
    ...
    public <fold text='⚡' expand='false'>static</fold> BuilderFieldShiftBuilder builder()<fold text=' { ' expand='false'> {
        </fold><fold text='🔙' expand='false'>return</fold> new BuilderFieldShiftBuilder();<fold text=' }' expand='false'>
    ...
    <fold text='@Builder @AllArgsConstructor(default) @Getter p' expand='false'>p</fold>ublic <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> UserData2 <fold text='{...}' expand='true'>{
        ...
        public <fold text='⚡' expand='false'>static</fold> UserData2Builder builder()<fold text=' { ' expand='false'> {
            </fold><fold text='🔙' expand='false'>return</fold> new UserData2Builder();<fold text=' }' expand='false'>
        }</fold><fold text='' expand='false'>
    ...
    <fold text='@NoArgsConstructor(default) @ToString p' expand='false'>p</fold>ublic <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> BuilderFieldShiftBuilder <fold text='{...}' expand='true'>{
        ...
        public FieldShiftBuilder build()<fold text=' { ' expand='false'> {
            </fold><fold text='🔙' expand='false'>return</fold> new FieldShiftBuilder(username, active, userIdentifier, child);<fold text=' }' expand='false'>
        }</fold><fold text='' expand='false'>
