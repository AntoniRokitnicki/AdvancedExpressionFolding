...
public class ConstTestData {
    ...
    private <fold text='⚡' expand='false'><fold text='const' expand='false'>static</fold> <fold text='🔒' expand='false'>final</fold> </fold><fold text='' expand='false'>String</fold> PRIVATE_STATIC_FINAL_VAR = "";
    ...
    private <fold text='🔒' expand='false'><fold text='const' expand='false'>final</fold> <fold text='⚡' expand='false'>static</fold> </fold><fold text='' expand='false'>String</fold> PRIVATE_FINAL_STATIC_VAR = "";
    ...
    <fold text='⚡' expand='false'>static</fold> private <fold text='🔒' expand='false'>final</fold> String STATIC_PRIVATE_FINAL_VAR = "";
    ...
    <fold text='⚡' expand='false'>static</fold> <fold text='🔒' expand='false'>final</fold> private String STATIC_FINAL_PRIVATE_VAR = "";
    ...
    <fold text='🔒' expand='false'>final</fold> private <fold text='⚡' expand='false'>static</fold> String FINAL_PRIVATE_STATIC_VAR = "";
    ...
    <fold text='🔒' expand='false'>final</fold> <fold text='⚡' expand='false'>static</fold> private String FINAL_STATIC_PRIVATE_VAR = "";
    ...
    private <fold text='⚡' expand='false'>static</fold> String PRIVATE_STATIC_VAR = "";
    ...
    private <fold text='🔒' expand='false'>final</fold> String PRIVATE_FINAL_VAR = "";
    ...
    <fold text='⚡' expand='false'>static</fold> private String STATIC_PRIVATE_VAR = "";
    ...
    <fold text='🔒' expand='false'>final</fold> private String FINAL_PRIVATE_VAR = "";
    ...
    <fold text='⚡' expand='false'><fold text='default const' expand='false'>static</fold> <fold text='🔒' expand='false'>final</fold> <fold text='' expand='false'></fold>int</fold> VERSION_REF = VERSION;
    ...
    class ConstsWithAnnotaiton <fold text='{...}' expand='true'>{
        ...
        @Deprecated
        <fold text='default econst' expand='false'><fold text='⚡' expand='false'>static</fold> <fold text='🔒' expand='false'>final</fold></fold> EOrder ENUM_STATIC_IMPORT = SECOND;

        @Deprecated
        <fold text='const' expand='false'>public <fold text='⚡' expand='false'>static</fold> <fold text='🔒' expand='false'>final</fold> </fold><fold text='' expand='false'>String</fold> PUBLIC_STATIC_FINAL_VAR = "";

        @Deprecated
        private <fold text='⚡' expand='false'><fold text='const' expand='false'>static</fold> <fold text='🔒' expand='false'>final</fold> <fold text='' expand='false'></fold>String</fold> PRIVATE_STATIC_FINAL_VAR = "";
        ...
        @Deprecated
        private <fold text='🔒' expand='false'><fold text='const' expand='false'>final</fold> <fold text='⚡' expand='false'>static</fold> <fold text='' expand='false'></fold>String</fold> PRIVATE_FINAL_STATIC_VAR = "";
        ...
        @Deprecated
        <fold text='const' expand='false'><fold text='🔒' expand='false'>final</fold> public <fold text='⚡' expand='false'>static</fold> </fold><fold text='' expand='false'>String</fold> FINAL_PUBLIC_STATIC_VAR = "";
