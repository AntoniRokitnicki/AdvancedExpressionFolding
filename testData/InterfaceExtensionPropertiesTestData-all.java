...
public <fold text='🏛️' expand='false'>class</fold> InterfaceExtensionPropertiesTestData {
    ...
    <fold text='🖥️' expand='false'>interface</fold> TODO <fold text='{...}' expand='true'>{
        public <fold text='🖥️' expand='false'>interface</fold> NullableUser <fold text='{...}' expand='true'>{
           <fold text='@Getter ' expand='false'> </fold>@Nullable
            Integer <fold text='a' expand='true'>getA</fold>ge<fold text='' expand='true'>()</fold>;
           <fold text='@Setter ' expand='false'> </fold><fold text='int' expand='true'>void</fold> <fold text='a' expand='true'>setA</fold>ge<fold text='' expand='true'>(<fold text='' expand='false'>@Nullable</fold><fold text='' expand='false'> </fold><fold text='🔢' expand='false'>int<fold text='? ' expand='false'></fold> </fold>age)</fold>;
           <fold text='@Getter ' expand='false'> </fold>@Nullable
            String <fold text='n' expand='true'>getN</fold>ame<fold text='' expand='true'>()</fold>;
           <fold text='@Setter ' expand='false'> </fold><fold text='String' expand='true'>void</fold> <fold text='n' expand='true'>setN</fold>ame<fold text='' expand='true'>(<fold text='' expand='false'>@Nullable</fold><fold text='' expand='false'> </fold>String<fold text='? ' expand='false'> </fold>name)</fold>;
        }</fold>

        public <fold text='🖥️' expand='false'>interface</fold> NotNullUser <fold text='{...}' expand='true'>{
           <fold text='@Getter ' expand='false'> </fold>@NotNull
            String <fold text='n' expand='true'>getN</fold>ame<fold text='' expand='true'>()</fold>;
           <fold text='@Setter ' expand='false'> </fold><fold text='String' expand='true'>void</fold> <fold text='n' expand='true'>setN</fold>ame<fold text='' expand='true'>(<fold text='' expand='false'>@NotNull</fold><fold text='' expand='false'> </fold>String<fold text='!! ' expand='false'> </fold>name)</fold>;
           <fold text='@Getter ' expand='false'> </fold><fold text='🔢' expand='false'>int</fold> <fold text='a' expand='true'>getA</fold>ge<fold text='' expand='true'>()</fold>;
        }</fold>
    }</fold>

    public <fold text='🖥️' expand='false'>interface</fold> User <fold text='{...}' expand='true'>{
       <fold text='@Getter ' expand='false'> </fold>String <fold text='n' expand='true'>getN</fold>ame<fold text='' expand='true'>()</fold>;
       <fold text='@Setter ' expand='false'> </fold><fold text='String' expand='true'>void</fold> <fold text='n' expand='true'>setN</fold>ame<fold text='' expand='true'>(String name)</fold>;

       <fold text='@Getter ' expand='false'> </fold><fold text='🔢' expand='false'>int</fold> <fold text='a' expand='true'>getA</fold>ge<fold text='' expand='true'>()</fold>;
       <fold text='@Setter ' expand='false'> </fold><fold text='int' expand='true'>void</fold> <fold text='a' expand='true'>setA</fold>ge<fold text='' expand='true'>(<fold text='🔢' expand='false'>int</fold> age)</fold>;
    }</fold>

    public <fold text='🖥️' expand='false'>interface</fold> PublicUser <fold text='{...}' expand='true'>{
       <fold text='@Getter ' expand='false'> </fold>public String <fold text='n' expand='true'>getN</fold>ame<fold text='' expand='true'>()</fold>;
       <fold text='@Setter ' expand='false'> </fold>public <fold text='String' expand='true'>void</fold> <fold text='n' expand='true'>setN</fold>ame<fold text='' expand='true'>(String name)</fold>;

       <fold text='@Getter ' expand='false'> </fold>public <fold text='🔢' expand='false'>int</fold> <fold text='a' expand='true'>getA</fold>ge<fold text='' expand='true'>()</fold>;
       <fold text='@Setter ' expand='false'> </fold>public <fold text='int' expand='true'>void</fold> <fold text='a' expand='true'>setA</fold>ge<fold text='' expand='true'>(<fold text='🔢' expand='false'>int</fold> age)</fold>;
    }</fold>
