...
public <fold text='🏛️' expand='false'>class</fold> InterfaceExtensionPropertiesTestData {
    ...
    <fold text='🖥️' expand='false'>interface</fold> Finder <fold text='{...}' expand='true'>{
       ...
       <fold text='@Finder ' expand='true'> </fold>String <fold text='tag' expand='true'>findTagByAge</fold>(<fold text='💾' expand='false'>byte</fold> <fold text='age' expand='true'>name</fold>);
