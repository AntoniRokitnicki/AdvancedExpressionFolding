...
<fold text='@Getter p' expand='false'>p</fold>ublic class NullableAnnotationCheckNotNullTestData {
    ...
    class PreconditionsCheck <fold text='{...}' expand='true'>{
        public void main(String<fold text='!!! ' expand='false'> </fold>args, Object<fold text='!!! ' expand='false'> </fold>o, Long<fold text='!!! ' expand='false'> </fold>l, NullableAnnotationCheckNotNullTestData z) <fold text='{...}' expand='true'>{<fold text='' expand='true'>
            ...
            Preconditions.checkNotNull(z.getSaaa());<fold text='' expand='true'>
            </fold><fold text='' expand='false'><fold text='' expand='true'>Preconditions.checkNotNull(</fold>o<fold text='!!' expand='false'>)</fold>;</fold>
            System.out.println();
        }</fold>

        public void mainMsgs(String<fold text='!!! ' expand='false'> </fold>args, Object<fold text='!!! ' expand='false'> </fold>o, Long<fold text='!!! ' expand='false'> </fold>l, NullableAnnotationCheckNotNullTestData z) <fold text='{...}' expand='true'>{<fold text='' expand='true'>
            ...
            Preconditions.checkNotNull(z.getSaaa(), "o is null");<fold text='' expand='true'>
        ...
        public void mainConflictAnnotations(@Nullable String<fold text='!!! ' expand='false'> </fold>args, @Nullable Object<fold text='!!! ' expand='false'> </fold>o, @Nullable Long<fold text='!!! ' expand='false'> </fold>l, @Nullable NullableAnnotationCheckNotNullTestData z) <fold text='{...}' expand='true'>{<fold text='' expand='true'>
            </fold><fold text='' expand='false'><fold text='' expand='true'>Preconditions.checkNotNull(</fold>args<fold text='!!' expand='false'>)</fold>;</fold><fold text='' expand='true'>
            </fold><fold text='' expand='false'><fold text='' expand='true'>Preconditions.checkNotNull(</fold>l<fold text='!!' expand='false'>)</fold>;</fold>
            Preconditions.checkNotNull(z.getSaaa());<fold text='' expand='true'>
            <fold text='' expand='false'><fold text='' expand='true'></fold>Preconditions.checkNotNull(</fold>o<fold text='!!' expand='false'>)</fold>;</fold>
            System.out.println();
        }</fold>

        public void mainConflictAnnotationsWithMsg(@Nullable String<fold text='!!! ' expand='false'> </fold>args, @Nullable Object<fold text='!!! ' expand='false'> </fold>o, @Nullable Long<fold text='!!! ' expand='false'> </fold>l, @Nullable NullableAnnotationCheckNotNullTestData z) <fold text='{...}' expand='true'>{<fold text='' expand='true'>
            </fold><fold text='' expand='true'><fold text='' expand='false'>Preconditions.checkNotNull(</fold>args<fold text='!!' expand='false'>, "args are null")</fold>;</fold><fold text='' expand='true'>
            </fold><fold text='' expand='false'><fold text='' expand='true'>Preconditions.checkNotNull(</fold>l<fold text='!!' expand='false'>, "l is null")</fold>;</fold>
            Preconditions.checkNotNull(z.getSaaa(), "o is null");<fold text='' expand='true'>
            </fold><fold text='' expand='false'><fold text='' expand='true'>Preconditions.checkNotNull(</fold>o<fold text='!!' expand='false'>, "o is null")</fold>;</fold>
            System.out.println();
