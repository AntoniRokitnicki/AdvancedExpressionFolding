...
public <fold text='🏛️' expand='false'>class</fold> LombokPatternOffTestData {

    <fold text='🚫' expand='false'>private</fold> <fold text='⚡' expand='false'><fold text='const' expand='false'>static</fold> <fold text='🔒' expand='false'>final</fold> </fold><fold text='' expand='false'>long</fold> serialVersionUID = 1234567L;
    ...
    public <fold text='🏛️' expand='false'>class</fold> LombokSetters <fold text='{...}' expand='true'>{
        LombokPatternOffTestData data;
        <fold text='🔘' expand='false'>boolean</fold> ok;
    ...
    public <fold text='🏛️' expand='false'>class</fold> ToStringFull <fold text='{...}' expand='true'>{
        LombokPatternOffTestData data;
        <fold text='🔘' expand='false'>boolean</fold> ok;
    ...
    public <fold text='🏛️' expand='false'>class</fold> EqualsAndHashCodeFull <fold text='{...}' expand='true'>{
        LombokPatternOffTestData data;
        <fold text='🔘' expand='false'>boolean</fold> ok;
    ...
    public <fold text='🏛️' expand='false'>class</fold> EqualsFull <fold text='{...}' expand='true'>{
        LombokPatternOffTestData data;
        <fold text='🔘' expand='false'>boolean</fold> ok;
    ...
    public <fold text='🏛️' expand='false'>class</fold> HashCodeFull <fold text='{...}' expand='true'>{
        LombokPatternOffTestData data;
        <fold text='🔘' expand='false'>boolean</fold> ok;
    ...
    public <fold text='🏛️' expand='false'>class</fold> DataFull <fold text='{...}' expand='true'>{
        LombokPatternOffTestData data;
        <fold text='🔘' expand='false'>boolean</fold> ok;
        ...
        public <fold text='🏛️' expand='false'>class</fold> DataWithoutToString <fold text='{...}' expand='true'>{
            LombokPatternOffTestData data;
            <fold text='🔘' expand='false'>boolean</fold> ok;
            ...
            public <fold text='🔘' expand='false'>boolean</fold> isOk()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='' expand='false'>return</fold><fold text='' expand='true'> </fold>ok<fold text='' expand='true'>;</fold><fold text=' }' expand='false'><fold text='' expand='true'>
            </fold>}</fold>
            ...
            <fold text='' expand='true'>@Override</fold>
            public <fold text='🔢' expand='false'>int</fold> hashCode()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold><fold text='' expand='false'></fold>return</fold><fold text='' expand='true'> </fold>new HashCodeBuilder(17, 37).append(data).append(ok).toHashCode()<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
            </fold>}</fold>

        }</fold>

        public <fold text='🏛️' expand='false'>class</fold> DataWithPartialGetters <fold text='{...}' expand='true'>{
            LombokPatternOffTestData data;
            <fold text='🔘' expand='false'>boolean</fold> ok;
        ...
        public <fold text='🏛️' expand='false'>class</fold> DataWithPartialSetters <fold text='{...}' expand='true'>{
            LombokPatternOffTestData data;
            <fold text='🔘' expand='false'>boolean</fold> ok;
            ...
            public <fold text='🔘' expand='false'>boolean</fold> isOk()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='' expand='false'>return</fold><fold text='' expand='true'> </fold>ok<fold text='' expand='true'>;<fold text='' expand='true'><fold text=' }' expand='false'></fold>
            </fold>}</fold>
    ...
    public <fold text='🏛️' expand='false'>class</fold> DirtyLombokGetters <fold text='{...}' expand='true'>{
        ...
        public <fold text='🔘' expand='false'>boolean</fold> isDirty()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='false'>return</fold><fold text='' expand='true'> </fold>dirty2<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold>
    ...
    public <fold text='🏛️' expand='false'>class</fold> LogAnnotation <fold text='{...}' expand='true'>{
        public <fold text='🏛️' expand='false'>class</fold> LogJava <fold text='{...}' expand='true'>{
            Logger log = Logger.getLogger("LogAnnotation.class");
        }</fold>

        public <fold text='🏛️' expand='false'>class</fold> LogJava2 <fold text='{...}' expand='true'>{
            Logger log = Logger.getLogger("LogAnnotation.class");
        }</fold>

        public <fold text='🏛️' expand='false'>class</fold> LogDiffrentFieldName <fold text='{...}' expand='true'>{
            <fold text='const' expand='false'>public <fold text='⚡' expand='false'>static</fold> <fold text='🔒' expand='false'>final</fold> </fold><fold text='' expand='false'>Logger</fold> logger = Logger.getLogger("LogAnnotation.class");
        }</fold>

        public <fold text='🏛️' expand='false'>class</fold> LogCustomNameDeprecated <fold text='{...}' expand='true'>{
            @Deprecated
            <fold text='⚡' expand='false'><fold text='default const' expand='false'>static</fold> <fold text='🔒' expand='false'>final</fold> </fold><fold text='' expand='false'>Logger</fold> xlogger = Logger.getLogger("LogAnnotation.class");
        }</fold>

        public <fold text='🏛️' expand='false'>class</fold> TripleLogJava <fold text='{...}' expand='true'>{
            Logger log = Logger.getLogger("LogAnnotation.class");
            <fold text='const' expand='false'>public <fold text='⚡' expand='false'>static</fold> <fold text='🔒' expand='false'>final</fold> </fold><fold text='' expand='false'>Logger</fold> log2 = Logger.getLogger("LogAnnotation.class");
            <fold text='⚡' expand='false'>static</fold> Logger log3 = Logger.getLogger("LogAnnotation.class");
        }</fold>
    }</fold>
    ...
    public <fold text='🏛️' expand='false'>class</fold> NoArgsConstructorAnnotation <fold text='{...}' expand='true'>{
        public <fold text='🏛️' expand='false'>class</fold> NoArgsConstructor <fold text='{...}' expand='true'>{
            public NoArgsConstructor() <fold text='{}' expand='true'>{
            }</fold>
        }</fold>
        <fold text='🏛️' expand='false'>class</fold> NoArgsConstructorPrivate <fold text='{...}' expand='true'>{
            <fold text='🚫' expand='false'>private</fold> NoArgsConstructorPrivate() <fold text='{}' expand='true'>{
            }</fold>
        }</fold>
        ...
        public <fold text='🏛️' expand='false'>class</fold> ProtectedNoArgsConstructorSuperAfter <fold text='{...}' expand='true'>{
            <fold text='🛡️' expand='false'>protected</fold> ProtectedNoArgsConstructorSuperAfter() <fold text='{}' expand='true'>{
                // comment
            }</fold>
        }</fold>
    ...
    public <fold text='🏛️' expand='false'>class</fold> AllArgsConstructorAnnotation <fold text='{...}' expand='true'>{
        ...
        public <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> AllArgsSuper <fold text='{...}' expand='true'>{
            <fold text='🚫' expand='false'>private</fold> String field1;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔢' expand='false'>int</fold> field2;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔘' expand='false'>boolean</fold> field3;
        ...
        public <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> StaticNameArgs <fold text='{...}' expand='true'>{
            <fold text='🚫' expand='false'>private</fold> String field1;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔢' expand='false'>int</fold> field2;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔘' expand='false'>boolean</fold> field3;
    ...
    public <fold text='🏛️' expand='false'>class</fold> RequiredArgsConstructorAnnotation <fold text='{...}' expand='true'>{
        public <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> RequiredArgs <fold text='{...}' expand='true'>{
        ...
        public <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> RequiredArgsSuper <fold text='{...}' expand='true'>{
            <fold text='🚫' expand='false'>private</fold> <fold text='🔒' expand='false'>final</fold> String field1;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔒' expand='false'>final</fold> <fold text='🔢' expand='false'>int</fold> field2;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔒' expand='false'>final</fold> <fold text='🔘' expand='false'>boolean</fold> field3;
    ...
    public <fold text='🏛️' expand='false'>class</fold> ValueAnnotation <fold text='{...}' expand='true'>{
        public <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> ValueArgs <fold text='{...}' expand='true'>{
            <fold text='🚫' expand='false'>private</fold> <fold text='🔒' expand='false'>final</fold> String field1;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔒' expand='false'>final</fold> <fold text='🔢' expand='false'>int</fold> field2;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔒' expand='false'>final</fold> <fold text='🔘' expand='false'>boolean</fold> field3;
            ...
            public String getField1()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='' expand='false'>return</fold><fold text='' expand='true'> </fold>field1<fold text='' expand='true'>;<fold text='' expand='true'><fold text=' }' expand='false'></fold>
            </fold>}</fold>
        ...
        public <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> ValueArgsSuper <fold text='{...}' expand='true'>{
            <fold text='🚫' expand='false'>private</fold> <fold text='🔒' expand='false'>final</fold> String field1;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔒' expand='false'>final</fold> <fold text='🔢' expand='false'>int</fold> field2;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔒' expand='false'>final</fold> <fold text='🔘' expand='false'>boolean</fold> field3;
            ...
            public <fold text='🔢' expand='false'>int</fold> getField2()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='' expand='false'>return</fold><fold text='' expand='true'> </fold>field2<fold text='' expand='true'>;<fold text='' expand='true'><fold text=' }' expand='false'></fold>
            </fold>}</fold>
            public <fold text='🔘' expand='false'>boolean</fold> isField3()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='' expand='false'>return</fold><fold text='' expand='true'> </fold>field3<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
            </fold>}</fold>
        ...
        public <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> ValueWihhoutEqualsAndHashcode <fold text='{...}' expand='true'>{
            <fold text='🚫' expand='false'>private</fold> <fold text='🔒' expand='false'>final</fold> String field1;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔒' expand='false'>final</fold> <fold text='🔢' expand='false'>int</fold> field2;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔒' expand='false'>final</fold> <fold text='🔘' expand='false'>boolean</fold> field3;
            ...
            public <fold text='🔘' expand='false'>boolean</fold> isField3()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='' expand='false'>return</fold><fold text='' expand='true'> </fold>field3<fold text='' expand='true'>;</fold><fold text=' }' expand='false'><fold text='' expand='true'>
            </fold>}</fold>
        }</fold>
    }</fold>
    <fold text='🏛️' expand='false'>class</fold> SingleField <fold text='{...}' expand='true'>{
        ...
        public <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> Value <fold text='{...}' expand='true'>{
            ...
            <fold text='' expand='true'>@Override</fold>
            public <fold text='🔢' expand='false'>int</fold> hashCode()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='' expand='false'>return</fold><fold text='' expand='true'> </fold>Objects.hashCode(field1)<fold text='' expand='true'>;<fold text='' expand='true'><fold text=' }' expand='false'></fold>
            </fold>}</fold>
        }</fold>
    ...
    <fold text='🏛️' expand='false'>class</fold> FieldLevelValue <fold text='{...}' expand='true'>{
        ...
        public String getName()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='false'>return</fold><fold text='' expand='true'> </fold>name<fold text='' expand='true'>;<fold text='' expand='true'><fold text=' }' expand='false'></fold>
        </fold>}</fold>
    ...
    <fold text='🏛️' expand='false'>class</fold> ClassWithBuilder <fold text='{...}' expand='true'>{
        ...
        <fold text='🏛️' expand='false'>class</fold> ClassWithBuilderBuilder <fold text='{...}' expand='true'>{
            ...
            public ClassWithBuilder build()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='' expand='false'>return</fold><fold text='' expand='true'> </fold>new ClassWithBuilder()<fold text='' expand='true'>;<fold text='' expand='true'><fold text=' }' expand='false'></fold>
            </fold>}</fold>
        }</fold>
    }</fold>

    <fold text='🏛️' expand='false'>class</fold> Constructors <fold text='{...}' expand='true'>{
        public <fold text='🏛️' expand='false'>class</fold> FiveConstructors <fold text='{...}' expand='true'>{
            <fold text='🚫' expand='false'>private</fold> <fold text='🔢' expand='false'>int</fold> field1;
            <fold text='🚫' expand='false'>private</fold> String field2;
            <fold text='🚫' expand='false'>private</fold> <fold text='⚖️' expand='false'>double</fold> field3;
        ...
        public <fold text='🏛️' expand='false'>class</fold> FiveConstructorsMod <fold text='{...}' expand='true'>{
            <fold text='🚫' expand='false'>private</fold> <fold text='🔢' expand='false'>int</fold> field1;
            <fold text='🚫' expand='false'>private</fold> String field2;
            <fold text='🚫' expand='false'>private</fold> <fold text='⚖️' expand='false'>double</fold> field3;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔘' expand='false'>boolean</fold> field4;
