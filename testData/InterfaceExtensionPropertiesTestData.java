...
public class InterfaceExtensionPropertiesTestData {
    ...
    interface TODO <fold text='{...}' expand='true'>{
        public interface NullableUser <fold text='{...}' expand='true'>{
           ...
           <fold text='@Setter ' expand='false'> </fold><fold text='int' expand='true'>void</fold> <fold text='a' expand='true'>setA</fold>ge<fold text='' expand='true'>(<fold text='' expand='false'>@Nullable</fold><fold text='' expand='false'> </fold>int<fold text='? ' expand='false'> </fold>age)</fold>;
           <fold text='@Getter ' expand='false'> </fold>@Nullable
        ...
        public interface NotNullUser <fold text='{...}' expand='true'>{
           ...
           <fold text='@Getter ' expand='false'> </fold>int <fold text='a' expand='true'>getA</fold>ge<fold text='' expand='true'>()</fold>;
        }</fold>
    }</fold>
    ...
    public interface User <fold text='{...}' expand='true'>{
       ...
       <fold text='@Getter ' expand='false'> </fold>int <fold text='a' expand='true'>getA</fold>ge<fold text='' expand='true'>()</fold>;
       <fold text='@Setter ' expand='false'> </fold><fold text='int' expand='true'>void</fold> <fold text='a' expand='true'>setA</fold>ge<fold text='' expand='true'>(int age)</fold>;
    }</fold>
    ...
    public interface PublicUser <fold text='{...}' expand='true'>{
       ...
       <fold text='@Getter ' expand='false'> </fold>public int <fold text='a' expand='true'>getA</fold>ge<fold text='' expand='true'>()</fold>;
       <fold text='@Setter ' expand='false'> </fold>public <fold text='int' expand='true'>void</fold> <fold text='a' expand='true'>setA</fold>ge<fold text='' expand='true'>(int age)</fold>;
    }</fold>
    ...
    interface Finder <fold text='{...}' expand='true'>{
       ...
       <fold text='@FindBy ' expand='false'> </fold>String findTagByAge(byte name);
