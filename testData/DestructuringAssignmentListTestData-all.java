...
public <fold text='🏛️' expand='false'>class</fold> DestructuringAssignmentListTestData {
    public <fold text='💀' expand='false'>void</fold> enter(Data data, List<Data> list) <fold text='{...}' expand='true'>{
        ...
        <fold text='val' expand='false'><fold text='val (' expand='true'>Data</fold> </fold>first<fold text=', ' expand='true'> = list<fold text='.getFirst' expand='false'>.get</fold>(<fold text='' expand='false'>0</fold>);<fold text='' expand='true'></fold>
    ...
    <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> Data <fold text='{...}' expand='true'>{
        public Data getData()<fold text=' { ' expand='false'> {
            <fold text='🔙' expand='false'></fold>return</fold> <fold text='🕳️' expand='false'>null</fold>;<fold text=' }' expand='false'>
        }</fold>
