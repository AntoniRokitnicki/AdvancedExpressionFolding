...
<fold text='' expand='true'>@SuppressWarnings("ALL")</fold><fold text='' expand='true'>
</fold>public class DestructuringAssignmentListTestData {
    public void enter(Data data, List<Data> list) <fold text='{...}' expand='true'>{
        ...
        <fold text='val' expand='false'>Data</fold> ignored21 = data.<fold text='list' expand='false'>getList()<fold text='[' expand='false'></fold>.get(</fold>4<fold text=']' expand='false'>)</fold>;
        ...
        <fold text='var' expand='false'><fold text='var (' expand='true'>Data</fold> </fold>getter1<fold text=', ' expand='true'> = data.<fold text='list' expand='false'>getList()</fold><fold text='.getFirst' expand='false'>.get</fold>(<fold text='' expand='false'>0</fold>);</fold><fold text='' expand='true'>
        ...
        <fold text='val' expand='false'><fold text='var (' expand='true'>Data</fold> </fold>deepGetter1<fold text=', ' expand='true'> = data.<fold text='data' expand='false'>getData()</fold>.<fold text='list' expand='false'>getList()</fold><fold text='.getFirst' expand='false'>.get</fold>(<fold text='' expand='false'>0</fold>);<fold text='' expand='true'></fold>
    ...
    static class Data <fold text='{...}' expand='true'>{
        ...
        <fold text='' expand='true'>public</fold><fold text='' expand='true'> </fold><fold text='' expand='true'>List<Data></fold><fold text='' expand='true'> </fold>getList<fold text='' expand='true'>()</fold><fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>null<fold text='' expand='true'>;</fold><fold text=' ' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold>
    }</fold>
