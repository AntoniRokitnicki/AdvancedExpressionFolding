...
public class DestructuringAssignmentListTestData {
    public <fold text='💀' expand='false'>void</fold> enter(Data data, List<Data> list) <fold text='{...}' expand='true'>{
        ...
        <fold text='val' expand='false'>Data</fold> wrongParent1 = data.<fold text='list' expand='false'>getList()<fold text='.getFirst' expand='false'></fold>.get</fold>(<fold text='' expand='false'>0</fold>);
