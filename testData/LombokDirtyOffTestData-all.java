...
public <fold text='🏛️' expand='false'>class</fold> LombokDirtyOffTestData {
    ...
    public <fold text='🏛️' expand='false'>class</fold> DirtyLombokSetters <fold text='{...}' expand='true'>{
        ...
        <fold text='@Getter @EqualsAndHashCode p' expand='false'>p</fold>ublic <fold text='🏛️' expand='false'>class</fold> DirtyData <fold text='{...}' expand='true'>{
            ...
            </fold><fold text='' expand='false'>public <fold text='🔘' expand='false'>boolean</fold> isDirty()<fold text=' { ' expand='false'> {
                </fold><fold text='🔙' expand='false'>return</fold> dirty;<fold text=' }' expand='false'>
            }</fold></fold><fold text='' expand='false'>

            <fold text='' expand='false'></fold>public <fold text='🔘' expand='false'>boolean</fold> isOk()<fold text=' { ' expand='false'> {
                </fold><fold text='🔙' expand='false'>return</fold> ok;<fold text=' }' expand='false'>
            }</fold></fold><fold text='' expand='false'>
