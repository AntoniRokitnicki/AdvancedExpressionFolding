...
public <fold text='🏛️' expand='false'>class</fold> MethodDefaultParametersTestData {
    ...
    <fold text='🏛️' expand='false'>class</fold> OverloadedMethodAsDefaultParam <fold text='{...}' expand='true'>{
        public String applySort1(String criterionName)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>applySort1(criterionName, <fold text='❌' expand='false'>false</fold>)<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold>
        public String applySort1(String criterionName<fold text=' = "DESC",' expand='true'>,</fold> <fold text='🔘' expand='false'>boolean</fold> descending<fold text=' = false)' expand='true'>)</fold><fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>criterionName<fold text='' expand='true'>;<fold text='' expand='true'><fold text=' }' expand='false'></fold>
        </fold>}</fold>
        ...
        public String applySortWrongFirstType(<fold text='🔢' expand='false'>int</fold> criterionName) <fold text='{...}' expand='true'>{<fold text=' ' expand='true'>
            </fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>applySortWrongFirstType(<fold text='' expand='false'>String.valueOf(</fold>criterionName<fold text='' expand='false'>)</fold>, <fold text='❌' expand='false'>false</fold>)<fold text='' expand='true'>;</fold><fold text='' expand='true'>
        </fold>}</fold>
        public String applySortWrongFirstType(String criterionName, <fold text='🔘' expand='false'>boolean</fold> descending)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold><fold text='' expand='true'></fold>return</fold><fold text='' expand='true'> </fold>criterionName<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold>
    ...
    <fold text='🏛️' expand='false'>class</fold> MultipleDefaultParams <fold text='{...}' expand='true'>{
        ...
        public String multipleDefaults(String name, <fold text='🔢' expand='false'>int</fold> count)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>multipleDefaults(name, count, <fold text='❌' expand='false'>false</fold>)<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold>
        <fold text='' expand='true'>public String multipleDefaults(String name)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>multipleDefaults(name, 10, <fold text='❌' expand='false'>false</fold>)<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold></fold>
    }</fold>
    ...
    <fold text='🏛️' expand='false'>class</fold> ChainedDefaults <fold text='{...}' expand='true'>{
        ...
        <fold text='' expand='true'>public String chainedDefaults(String name, <fold text='🔢' expand='false'>int</fold> count)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>chainedDefaults(name, count, <fold text='✅' expand='false'>true</fold>)<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold></fold>
        public String chainedDefaults(String name)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>chainedDefaults(name, 5)<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold>
    }</fold>
    ...
    <fold text='🏛️' expand='false'>class</fold> StaticDefaults <fold text='{...}' expand='true'>{
        ...
        <fold text='' expand='true'>public <fold text='⚡' expand='false'>static</fold> String staticWithDefaults(String name)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>staticWithDefaults(name, <fold text='✅' expand='false'>true</fold>)<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold></fold>
    }</fold>
    ...
    <fold text='🏛️' expand='false'>class</fold> DifferentReturnTypes <fold text='{...}' expand='true'>{
        ...
        public <fold text='🔢' expand='false'>int</fold> differentReturns(<fold text='🔢' expand='false'>int</fold> value, <fold text='🔘' expand='false'>boolean</fold> asNumber)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>Integer.parseInt(differentReturns(value))<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold>
    }</fold>
    ...
    <fold text='🏛️' expand='false'>class</fold> MixedParameterTypes <fold text='{...}' expand='true'>{
        ...
        public String mixedTypes(String text, <fold text='🔢' expand='false'>int</fold> number)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>mixedTypes(text, number, <fold text='❌' expand='false'>false</fold>)<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold>
    ...
    <fold text='🏛️' expand='false'>class</fold> VarargDefaults <fold text='{...}' expand='true'>{
        public String varargMethod(String prefix, String... items<fold text=' = "default")' expand='true'>)</fold><fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold><fold text='' expand='true'></fold>return</fold><fold text='' expand='true'> </fold>prefix + String.join(",", items)<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold>
    ...
    <fold text='🏛️' expand='false'>class</fold> DifferentParameterNames <fold text='{...}' expand='true'>{
        public String differentParamNames(String name, <fold text='🔘' expand='false'>boolean</fold> enabled<fold text=' = true)' expand='true'>)</fold><fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return<fold text='' expand='true'></fold> </fold>name + enabled<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold>
        <fold text='' expand='true'>public String differentParamNames(String title)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>differentParamNames(title, <fold text='✅' expand='false'>true</fold>)<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold></fold>
    }</fold>
    ...
    <fold text='🏛️' expand='false'>class</fold> GenericMethodDefaults <fold text='{...}' expand='true'>{
        ...
        <fold text='' expand='true'>public <T> String genericMethod(T item)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>genericMethod(item, <fold text='❌' expand='false'>false</fold>)<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold></fold>
    }</fold>
