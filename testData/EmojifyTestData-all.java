...
public class EmojifyTestData {
    ...
    public class InterfaceImplementation implements InterfaceDat<fold text='a(1-interfaceMethod)' expand='true'>a</fold> <fold text='{...}' expand='true'>{
        ...
        public void interfaceMethod() <fold text='{ // overrides from InterfaceData' expand='true'><fold text='{}' expand='true'>{</fold>
        }</fold>
    }</fold>
    ...
    <fold text='@AllArgsConstructor @Getter @Setter p' expand='false'>p</fold>ublic class TransientVolatileData implements java.io.Serializabl<fold text='e(0-)' expand='true'>e</fold> <fold text='{...}' expand='true'>{
        ...
        <fold text='' expand='false'></fold>public TransientVolatileData(int transientField, boolean volatileField) <fold text='{...}' expand='true'>{
            ...
            </fold></fold>this.transientField = <fold text='<<' expand='false'>transientField<fold text='' expand='true'></fold>;</fold><fold text=' ' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold><fold text='' expand='false'></fold>
    ...
    <fold text='@AllArgsConstructor p' expand='false'>p</fold>ublic class InterfaceUsage implements Comparabl<fold text='e(0-)' expand='true'>e</fold><InterfaceUsage> <fold text='{...}' expand='true'>{
        ...
        public int compareTo(InterfaceUsage other)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return<fold text='' expand='true'></fold> </fold>Integer.compare(this.value, other.value)<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold>
    }</fold>
    ...
    public class DefaultMethodInInterface implements DefaultMethodInterfac<fold text='e(1-abstractMethod)' expand='true'>e</fold> <fold text='{...}' expand='true'>{
        <fold text='' expand='true'>@Override</fold>
        public void abstractMethod() <fold text='{ // overrides from DefaultMethodInterface' expand='true'><fold text='{}' expand='true'>{</fold>
        }</fold>
    }</fold>
    ...
    <fold text='@Builder(Builder) p' expand='false'>p</fold>ublic class BuilderPatternUsage <fold text='{...}' expand='true'>{
        ...
        public class Builder <fold text='{...}' expand='true'>{
            ...
            public BuilderPatternUsage build()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>new BuilderPatternUsage(this)<fold text='' expand='true'>;<fold text='' expand='true'><fold text=' }' expand='false'></fold>
            </fold>}</fold>
        }</fold>
    }</fold>
    ...
    class NullUsage <fold text='{...}' expand='true'>{
        public class Data <fold text='{...}' expand='true'>{
            ...
            public String methodWithNullTernary(String input)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='' expand='true'>return<fold text='' expand='true'></fold> </fold><fold text='' expand='false'>input != null ? </fold>input<fold text=' ?: ' expand='false'> : </fold>null<fold text='' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
            </fold>}</fold>
            ...
            public void methodWithNullInOptional() <fold text='{...}' expand='true'>{<fold text=' ' expand='true'>
                <fold text='val' expand='false'></fold>java.util.Optional<String></fold> optional = java.util.<fold text='' expand='false'>Optional.ofNullable(</fold>null<fold text='' expand='false'>)</fold>;<fold text=' ' expand='true'>
            </fold>}</fold>
    ...
    class SingletonUsage <fold text='{...}' expand='true'>{
        ...
        static class Singleton <fold text='{...}' expand='true'>{
            ...
            Singleton main(Singleton s)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>this<fold text='' expand='true'>;<fold text='' expand='true'><fold text=' }' expand='false'></fold>
            </fold>}</fold><fold text='' expand='false'>
