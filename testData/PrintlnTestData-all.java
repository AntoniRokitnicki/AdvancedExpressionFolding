...
<fold text='🏛️' expand='false'>class</fold> PrintlnTestData {
    ...
    <fold text='💀' expand='false'>void</fold> println(String string) <fold text='{...}' expand='true'>{
        ...
        <fold text='' expand='false'>System.out.</fold>println(<fold text='✅' expand='false'>true</fold>);
...
</fold><fold text='📍' expand='false'>this</fold>.<fold text='class' expand='false'>getClass()</fold><fold text='}")' expand='false'>)</fold>;
