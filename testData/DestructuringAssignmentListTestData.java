...
public class DestructuringAssignmentListTestData {
    public void enter(Data data, List<Data> list) <fold text='{...}' expand='true'>{
        ...
        <fold text='val' expand='false'><fold text='val (' expand='true'>Data</fold> </fold>first<fold text=', ' expand='true'> = list.get(0);</fold><fold text='' expand='true'>
        ...
        <fold text='var' expand='false'><fold text='var (' expand='true'>Data</fold> </fold>getter1<fold text=', ' expand='true'> = data.<fold text='list' expand='false'>getList()</fold>.get(0);</fold><fold text='' expand='true'>
        ...
        <fold text='val' expand='false'><fold text='var (' expand='true'>Data</fold> </fold>deepGetter1<fold text=', ' expand='true'> = data.<fold text='data' expand='false'>getData()</fold>.<fold text='list' expand='false'>getList()</fold>.get(0);</fold><fold text='' expand='true'>
