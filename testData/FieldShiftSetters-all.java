...
<fold text='@NoArgsConstructor @Getter @Setter p' expand='false'>p</fold>ublic <fold text='🏛️' expand='false'>class</fold> FieldShiftSetters {
    ...
    </fold><fold text='' expand='false'>public <fold text='💀' expand='false'>void</fold> setUsername(String username)<fold text=' { ' expand='false'> {
        </fold>this.username = <fold text='<<' expand='false'>username</fold>;<fold text=' }' expand='false'>
    }</fold><fold text='' expand='false'></fold>

    </fold><fold text='' expand='false'>public <fold text='💀' expand='false'>void</fold> setActive(<fold text='🔘' expand='false'>boolean</fold> active)<fold text=' { ' expand='false'> {
        </fold>this.active = <fold text='<<' expand='false'>active</fold>;<fold text=' }' expand='false'>
    }</fold></fold><fold text='' expand='false'>

    </fold><fold text='' expand='false'>public <fold text='💀' expand='false'>void</fold> setUserIdentifier(String userIdentifier)<fold text=' { ' expand='false'> {
        </fold>this.userIdentifier = <fold text='<<' expand='false'>userIdentifier</fold>;<fold text=' }' expand='false'>
    }</fold><fold text='' expand='false'></fold>

    </fold><fold text='' expand='false'>public <fold text='💀' expand='false'>void</fold> setChild(FieldShiftSetters child)<fold text=' { ' expand='false'> {
        </fold>this.child = <fold text='<<' expand='false'>child</fold>;<fold text=' }' expand='false'>
    }</fold></fold><fold text='' expand='false'>

    </fold><fold text='' expand='false'>public List<String> getList()<fold text=' { ' expand='false'> {
        </fold><fold text='🔙' expand='false'>return</fold> list;<fold text=' }' expand='false'>
    }</fold></fold><fold text='' expand='false'>

    </fold><fold text='' expand='false'>public <fold text='💀' expand='false'>void</fold> setList(List<String> list)<fold text=' { ' expand='false'> {
    ...
    public <fold text='⚡' expand='false'>static</fold> FieldShiftSetters mapPojoChain(FieldShiftSetters source) <fold text='{...}' expand='true'>{
        ...
        result.<fold text='active = ' expand='false'>setActive(</fold>source.<fold text='child' expand='false'>getChild()<fold text='<<' expand='false'></fold>.isActive()</fold><fold text='' expand='false'>)</fold>;
    ...
    <fold text='🚫' expand='false'>private</fold> <fold text='⚡' expand='false'>static</fold> String changer(String username)<fold text=' { ' expand='false'> {
        ...
        </fold><fold text='🔙' expand='false'>return</fold> <fold text='📍' expand='false'>this</fold>.username;<fold text=' }' expand='false'>
    }</fold><fold text='' expand='false'></fold>

    </fold><fold text='' expand='false'>public <fold text='🔘' expand='false'>boolean</fold> isActive()<fold text=' { ' expand='false'> {
        </fold><fold text='🔙' expand='false'>return</fold> <fold text='📍' expand='false'>this</fold>.active;<fold text=' }' expand='false'>
    }</fold></fold><fold text='' expand='false'>

    </fold><fold text='' expand='false'>public String getUserIdentifier()<fold text=' { ' expand='false'> {
        </fold><fold text='🔙' expand='false'>return</fold> <fold text='📍' expand='false'>this</fold>.userIdentifier;<fold text=' }' expand='false'>
    }</fold><fold text='' expand='false'></fold>

    </fold><fold text='' expand='false'>public FieldShiftSetters getChild()<fold text=' { ' expand='false'> {
        </fold><fold text='🔙' expand='false'>return</fold> <fold text='📍' expand='false'>this</fold>.child;<fold text=' }' expand='false'>
    }</fold></fold>
    ...
    <fold text='@NoArgsConstructor @Getter @Setter p' expand='false'>p</fold>ublic <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> UserData2 <fold text='{...}' expand='true'>{
        ...
        <fold text='' expand='false'></fold>public <fold text='💀' expand='false'>void</fold> setUserIdentifier(String userIdentifier)<fold text=' { ' expand='false'> {
            </fold>this.userIdentifier = <fold text='<<' expand='false'>userIdentifier</fold>;<fold text=' }' expand='false'>
        }</fold></fold><fold text='' expand='false'>
