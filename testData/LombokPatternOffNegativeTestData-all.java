...
<fold text='' expand='true'>@SuppressWarnings("ALL")</fold><fold text='' expand='true'>
</fold><fold text='@Builder(ClassWithBuilder) @Getter @Setter @Serial p' expand='false'>p</fold>ublic class LombokPatternOffNegativeTestData {<fold text='' expand='false'>
    ...
    <fold text='@Getter p' expand='false'>p</fold>ublic class LombokGetters <fold text='{...}' expand='true'>{
        ...
        <fold text='' expand='false'></fold>public LombokPatternOffNegativeTestData getData()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
    ...
    public class NoArgsConstructorAnnotation <fold text='{...}' expand='true'>{
        ...
        <fold text='@NoArgsConstructor(// comment) p' expand='false'>p</fold>ublic class NoArgsConstructorSuperBefore <fold text='{...}' expand='true'>{<fold text='' expand='false'>
            <fold text='' expand='false'></fold>public NoArgsConstructorSuperBefore() <fold text='{...}' expand='true'>{<fold text=' ' expand='true'>
