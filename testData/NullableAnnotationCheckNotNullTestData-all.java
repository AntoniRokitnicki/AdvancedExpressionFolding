...
public <fold text='🏛️' expand='false'>class</fold> NullableAnnotationCheckNotNullTestData {
    ...
    <fold text='🏛️' expand='false'>class</fold> PreconditionsCheck <fold text='{...}' expand='true'>{
        ...
        public <fold text='💀' expand='false'>void</fold> mainConflictAnnotations(@Nullable String<fold text='!!! ' expand='false'> </fold>args, @Nullable Object o, @Nullable Long<fold text='!!! ' expand='false'> </fold>l, @Nullable Preconditions z) <fold text='{...}' expand='true'>{<fold text='' expand='true'>
        ...
        public <fold text='💀' expand='false'>void</fold> mainConflictAnnotationsWithMsg(@Nullable String<fold text='!!! ' expand='false'> </fold>args, @Nullable Object o, @Nullable Long<fold text='!!! ' expand='false'> </fold>l, @Nullable Preconditions z) <fold text='{...}' expand='true'>{<fold text='' expand='true'>
    ...
    <fold text='🏛️' expand='false'>class</fold> PreconditionsCheckReturn <fold text='{...}' expand='true'>{
        ...
        public <fold text='💀' expand='false'>void</fold> main1(String args, Object o, Long l, Preconditions z) <fold text='{...}' expand='true'>{
            ...
            <fold text='📍' expand='false'>this</fold>.data = <fold text='' expand='false'>Preconditions.checkNotNull(</fold>z.<fold text='data' expand='false'>getData()</fold><fold text='!!' expand='false'>)</fold>;
