...
public <fold text='🏛️' expand='false'>class</fold> NullableAnnotationCheckNotNullTestData {
    ...
    <fold text='🏛️' expand='false'>class</fold> PreconditionsCheckReturn <fold text='{...}' expand='true'>{
        ...
        public <fold text='💀' expand='false'>void</fold> main1(String args, Object o, Long l, Preconditions z) <fold text='{...}' expand='true'>{
            <fold text='📍' expand='false'>this</fold>.args = <fold text='' expand='false'>Preconditions.checkNotNull(</fold><fold text='<<' expand='false'>args</fold><fold text='!!' expand='false'>)</fold>;
            <fold text='📍' expand='false'>this</fold>.l = <fold text='' expand='false'>Preconditions.checkNotNull(</fold><fold text='<<' expand='false'>l</fold><fold text='!!' expand='false'>)</fold>;
            ...
            <fold text='📍' expand='false'>this</fold>.o = <fold text='' expand='false'>Preconditions.checkNotNull(</fold><fold text='<<' expand='false'>o</fold><fold text='!!' expand='false'>)</fold>;
            new HashMap<String, String>()<fold text='[' expand='false'>.put(</fold>"a"<fold text='] = ' expand='false'>, </fold>"b"<fold text='' expand='false'>)</fold>;
            printStatus();
        }</fold>
