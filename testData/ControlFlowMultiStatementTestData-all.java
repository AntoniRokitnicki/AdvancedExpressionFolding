...
public class ControlFlowMultiStatementTestData {
    public static void main(String[] args) <fold text='{...}' expand='true'>{
        ...
        <fold text='' expand='false'>System.out.</fold>println("...")<fold text='' expand='false'>;</fold>
                ...
                <fold text='' expand='false'>System.out.</fold>println("Success")<fold text='' expand='false'>;</fold>
        }</fold>
        if <fold text='' expand='false'>(</fold>args.length > 0<fold text='' expand='false'>)</fold> <fold text='' expand='false'><fold text='{...}' expand='true'>{</fold>
                <fold text='' expand='false'>System.out.</fold>println("Terminating")<fold text='' expand='false'>;</fold>
        }</fold> else <fold text='' expand='false'><fold text='{...}' expand='true'>{</fold>
                <fold text='' expand='false'>System.out.</fold>println("Terminating")<fold text='' expand='false'>;</fold>
        <fold text='' expand='false'>System.out.</fold>println("...")<fold text='' expand='false'>;</fold>
        }</fold>
        for <fold text='' expand='false'>(</fold><fold text='val' expand='false'>String</fold> arg : args<fold text='' expand='false'>)</fold> <fold text='{...}' expand='true'><fold text='' expand='false'>{</fold>
