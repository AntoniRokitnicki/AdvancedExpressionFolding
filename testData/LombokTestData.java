...
<fold text='@Builder(ClassWithBuilder) @Getter @Setter @Serial p' expand='false'>p</fold>ublic class LombokTestData {<fold text='' expand='false'>
    ...
    public class SupportedDirtyLombokSetters <fold text='{...}' expand='true'>{
        <fold text='@Setter(wrapper = Collections::unmodifiableList) p' expand='false'>p</fold>rivate List<String> setterWrapper;
        <fold text='@Setter(wrapper = this::localWrap) p' expand='false'>p</fold>rivate List<String> setterLocalWrapper;<fold text='' expand='false'>

        </fold><fold text='' expand='false'>public void setSetterWrapper(List<String> setterWrapper) <fold text='{...}' expand='true'>{
            this.setterWrapper = Collections.unmodifiableList(setterWrapper);
        }</fold></fold><fold text='' expand='false'>

        </fold><fold text='' expand='false'>public void setSetterLocalWrapper(List<String> setterLocalWrapper) <fold text='{...}' expand='true'>{
    ...
    public class ValueAnnotation <fold text='{...}' expand='true'>{
        ...
        <fold text='@Value p' expand='false'>p</fold>ublic static class ValueArgsSuper <fold text='{...}' expand='true'>{
            ...
            private final int field2;
            private final boolean field3;<fold text='' expand='false'>
            <fold text='' expand='false'></fold>public ValueArgsSuper(String field1, int field2, boolean field3) <fold text='{...}' expand='true'>{
                super();
                this.field1 = field1;
                this.field2 = field2;
                this.field3 = field3;
