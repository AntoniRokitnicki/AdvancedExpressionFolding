...
<fold text='@Builder(ClassWithBuilder) @Getter @Setter @Serial p' expand='false'>p</fold>ublic class LombokTestData {<fold text='' expand='false'>
    ...
    public class SupportedDirtyLombokGetters <fold text='{...}' expand='true'>{
        <fold text='@Getter(wrapper = Collections::unmodifiableList) p' expand='false'>p</fold>rivate List<String> wrapper;
        <fold text='@Getter(dirtyNoReference) p' expand='false'>p</fold>rivate List<String> wrapperWrongRef;
        <fold text='@Getter(dirty) p' expand='false'>p</fold>rivate List<String> wrapperDeeplyHiddenRef;

        <fold text='@Getter(wrapper = this::localWrap) p' expand='false'>p</fold>rivate List<String> localMethodWrappedList;
        ...
        </fold><fold text='' expand='false'>public List<String> getWrapperDeeplyHiddenRef() <fold text='{...}' expand='true'>{
            if (wrapper != null) <fold text='{...}' expand='true'>{
        ...
        </fold><fold text='' expand='false'>public List<String> getWrapperWrongRef()<fold text=' { ' expand='false'> {
            </fold>return Collections.unmodifiableList(wrapper);<fold text=' }' expand='false'>
        }</fold></fold><fold text='' expand='false'>

        </fold><fold text='' expand='false'>public List<String> getLocalMethodWrappedList()<fold text=' { ' expand='false'> {
            </fold>return localWrap(localMethodWrappedList);<fold text=' }' expand='false'>
        }</fold></fold><fold text='' expand='false'>

        </fold><fold text='' expand='false'>public List<String> getThisLocalMethodWrappedList()<fold text=' { ' expand='false'> {
            </fold>return this.localWrap(thisLocalMethodWrappedList);<fold text=' }' expand='false'>
        }</fold><fold text='' expand='false'></fold>

        </fold><fold text='' expand='false'>public List<String> getLazyLoadedList() <fold text='{...}' expand='true'>{
            if (lazyLoadedList == null) <fold text='{...}' expand='true'>{
    ...
    public class DirtyLombokSetters <fold text='{...}' expand='true'>{
        ...
        <fold text='@Setter(dirtyNoReference) p' expand='false'>p</fold>rivate boolean dirty2;
        <fold text='@Setter b' expand='false'>b</fold>oolean withoutThis;<fold text='' expand='false'>
        ...
        </fold><fold text='' expand='false'>public void setWithoutThis(boolean withoutThiss)<fold text=' { ' expand='false'> {
            </fold>withoutThis = withoutThiss;<fold text=' }' expand='false'>
        }</fold></fold>
    ...
    public class LogAnnotation <fold text='{...}' expand='true'>{
        ...
        <fold text='@Log p' expand='false'>p</fold>ublic class LogJava2 <fold text='{...}' expand='true'>{<fold text='' expand='false'>
            <fold text='' expand='false'></fold>Logger log = Logger.getLogger("LogAnnotation.class");</fold>
        }</fold>
    ...
    public class NoArgsConstructorAnnotation <fold text='{...}' expand='true'>{
        ...
        <fold text='@NoArgsConstructor(// comment) p' expand='false'>p</fold>ublic class NoArgsConstructorCommentBeforeSuper <fold text='{...}' expand='true'>{<fold text='' expand='false'>
            </fold><fold text='' expand='false'>public NoArgsConstructorCommentBeforeSuper() <fold text='{...}' expand='true'>{
                // comment
                super();
            }</fold></fold>
        }</fold>
        <fold text='@NoArgsConstructor(// comment) p' expand='false'>p</fold>ublic class NoArgsConstructorCommentAfterSuper <fold text='{...}' expand='true'>{<fold text='' expand='false'>
            </fold><fold text='' expand='false'>public NoArgsConstructorCommentAfterSuper() <fold text='{...}' expand='true'>{
                super();
                // comment
            }</fold></fold>
        }</fold>
    ...
    public class UtilityClassAnnotation <fold text='{...}' expand='true'>{
        <fold text='@UtilityClass p' expand='false'>p</fold>ublic static final class UtilityClassWithField <fold text='{...}' expand='true'>{
            public static final String NAME = "utility";<fold text='' expand='false'>

            </fold><fold text='' expand='false'>private UtilityClassWithField() <fold text='{...}' expand='true'>{
                throw new UnsupportedOperationException("This is a utility class and cannot be instantiated");
            }</fold></fold>
        }</fold>

        <fold text='@UtilityClass p' expand='false'>p</fold>ublic static final class UtilityClassWithMethod <fold text='{...}' expand='true'>{
            public static String greet()<fold text=' { ' expand='false'> {
                </fold>return "hello";<fold text=' }' expand='false'>
            }<fold text='' expand='false'></fold>

            </fold><fold text='' expand='false'>private UtilityClassWithMethod()<fold text=' { ' expand='false'> {
                </fold>throw new AssertionError("No instances for you");<fold text=' }' expand='false'>
            }</fold></fold>
        }</fold>
    }</fold>
    ...
    class Constructors <fold text='{...}' expand='true'>{
        ...
        class SingleConstructor <fold text='{...}' expand='true'>{
            ...
            </fold><fold text='' expand='false'>SingleConstructor(int field1)<fold text=' { ' expand='false'> {
                </fold>this.field1 = field1;<fold text=' }' expand='false'>
            }</fold></fold>
        }</fold>
        ...
        public class SingleConstructorNoMod <fold text='{...}' expand='true'>{
            ...
            private int field2;<fold text='' expand='false'>
            </fold><fold text='' expand='false'>public SingleConstructorNoMod(int field1)<fold text=' { ' expand='false'> {
                </fold>this.field1 = field1;<fold text=' }' expand='false'>
            }</fold></fold>
        }</fold>
