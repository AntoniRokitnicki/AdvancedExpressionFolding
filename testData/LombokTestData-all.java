...
<fold text='@Builder(ClassWithBuilder) @Getter @Setter @Serial p' expand='false'>p</fold>ublic class LombokTestData {<fold text='' expand='false'>
    ...
    public class DirtyLombokSetters <fold text='{...}' expand='true'>{
        ...
        private DirtyLombokSetters fluent;
        private DirtyLombokSetters fluentGuard;
        ...
        public DirtyLombokSetters setFluent(DirtyLombokSetters fluent) <fold text='{...}' expand='true'>{
            this.fluent = <fold text='<<' expand='false'>fluent</fold>;
            return this;
        }</fold>

        public DirtyLombokSetters setFluentGuard(DirtyLombokSetters fluentGuard) <fold text='{...}' expand='true'>{
            if <fold text='' expand='false'>(</fold>this.fluentGuard == fluentGuard<fold text='' expand='false'>)</fold> return this;
            this.fluentGuard = <fold text='<<' expand='false'>fluentGuard</fold>;
            return this;
        }</fold>
