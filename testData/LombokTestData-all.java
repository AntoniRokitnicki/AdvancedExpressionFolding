...
<fold text='@Builder @Getter @Setter @Serial p' expand='false'>p</fold>ublic <fold text='🏛️' expand='false'>class</fold> LombokTestData {<fold text='' expand='false'>
    ...
    </fold><fold text='🚫' expand='false'><fold text='' expand='false'>private</fold> <fold text='const' expand='false'><fold text='⚡' expand='false'>static</fold> <fold text='🔒' expand='false'>final</fold> </fold><fold text='' expand='false'>long</fold> serialVersionUID = 1234567L;</fold>
    ...
    <fold text='' expand='false'></fold>public void setData(LombokTestData data)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
        ...
        </fold></fold><fold text='📍' expand='false'>this</fold>.string = <fold text='<<' expand='false'>string</fold><fold text='' expand='true'>;</fold><fold text=' }' expand='false'><fold text=' ' expand='true'>
    </fold>}</fold></fold>
    ...
    <fold text='@Data p' expand='false'>p</fold>ublic <fold text='🏛️' expand='false'>class</fold> DataFull <fold text='{...}' expand='true'>{
        ...
        public boolean equals(Object o) <fold text='{...}' expand='true'>{
            ...
            <fold text='🔙' expand='false'>return</fold> <fold text='✨' expand='false'>new</fold> EqualsBuilder().append(ok, dataFull.ok).append(data, dataFull.data).<fold text='equals' expand='false'>isEquals()</fold>;
        }</fold><fold text='' expand='false'></fold>

        </fold><fold text='' expand='true'><fold text='' expand='false'>@Override</fold>
        public int hashCode()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold><fold text='✨' expand='false'>new</fold> HashCodeBuilder(17, 37).append(data).append(ok).toHashCode()<fold text=' ' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
        </fold>}</fold><fold text='' expand='false'></fold>

        </fold><fold text='' expand='true'><fold text='' expand='false'>@Override</fold>
        public String toString() <fold text='{...}' expand='true'>{
            <fold text='🔙' expand='false'>return</fold> <fold text='✨' expand='false'>new</fold> ToStringBuilder(<fold text='📍' expand='false'>this</fold>)
                    .append("data", data)
                    .append("ok", ok)
                    .toString();
        }</fold></fold>
        ...
        <fold text='@Getter @ToString @EqualsAndHashCode p' expand='false'>p</fold>ublic <fold text='🏛️' expand='false'>class</fold> DataWithPartialSetters <fold text='{...}' expand='true'>{
            ...
            public int hashCode()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold><fold text='' expand='true'></fold>return</fold><fold text='' expand='true'> </fold><fold text='✨' expand='false'>new</fold> HashCodeBuilder(17, 37).append(data).append(ok).toHashCode()<fold text=' ' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
            </fold>}</fold><fold text='' expand='false'></fold>
    ...
    public <fold text='🏛️' expand='false'>class</fold> DirtyLombokSetters <fold text='{...}' expand='true'>{
        ...
        public void setDirty(<fold text='🔘' expand='false'>boolean</fold> dirty)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
        ...
        public void setDirty2(<fold text='🔘' expand='false'>boolean</fold> dirty2)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
        ...
        public <fold text='🏛️' expand='false'>class</fold> DirtySingle <fold text='{...}' expand='true'>{
            ...
            public void setDirty(<fold text='🔘' expand='false'>boolean</fold> dirty)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='📍' expand='false'>this</fold>.ok = dirty<fold text='' expand='true'>;</fold><fold text=' }' expand='false'><fold text=' ' expand='true'>
            </fold>}</fold>
        }</fold>
    }</fold>
    ...
    public <fold text='🏛️' expand='false'>class</fold> LogAnnotation <fold text='{...}' expand='true'>{
        ...
        <fold text='@Log(logger) p' expand='false'>p</fold>ublic <fold text='🏛️' expand='false'>class</fold> LogDiffrentFieldName <fold text='{...}' expand='true'>{<fold text='' expand='false'>
            </fold><fold text='const' expand='false'><fold text='' expand='false'>public <fold text='⚡' expand='false'>static</fold> <fold text='🔒' expand='false'>final</fold> </fold><fold text='' expand='false'>Logger</fold> logger = Logger.getLogger("LogAnnotation.class");</fold>
        }</fold>
        ...
        <fold text='@Log @Log(log2) @Log(log3) p' expand='false'>p</fold>ublic <fold text='🏛️' expand='false'>class</fold> TripleLogJava <fold text='{...}' expand='true'>{<fold text='' expand='false'>
            ...
            <fold text='⚡' expand='false'><fold text='' expand='false'></fold>static</fold> Logger log3 = Logger.getLogger("LogAnnotation.class");</fold>
        }</fold>
    }</fold>
    ...
    public <fold text='🏛️' expand='false'>class</fold> NoArgsConstructorAnnotation <fold text='{...}' expand='true'>{
        ...
        public <fold text='🏛️' expand='false'>class</fold> NoArgsConstructorSuperParent <fold text='↔️' expand='false'>extends</fold> Parent <fold text='{...}' expand='true'>{
    ...
    public <fold text='🏛️' expand='false'>class</fold> AllArgsConstructorAnnotation <fold text='{...}' expand='true'>{
        ...
        <fold text='@AllArgsConstructor(private) p' expand='false'>p</fold>ublic <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> StaticNameArgs <fold text='{...}' expand='true'>{
            ...
            public static StaticNameArgs of(String field1, <fold text='🔢' expand='false'>int</fold> field2, <fold text='🔘' expand='false'>boolean</fold> field3) <fold text='{...}' expand='true'>{<fold text=' ' expand='true'>
                </fold><fold text='' expand='true'>return<fold text='' expand='true'></fold> </fold><fold text='✨' expand='false'>new</fold> StaticNameArgs(field1, field2, field3)<fold text=' ' expand='true'>;</fold><fold text='' expand='true'>
            </fold>}</fold>
        }</fold>
        ...
        <fold text='@AllArgsConstructor(protected) p' expand='false'>p</fold>ublic <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> ProtectedArgs <fold text='{...}' expand='true'>{
            ...
            <fold text='🚫' expand='false'>private</fold> <fold text='🔢' expand='false'>int</fold> field2;
            <fold text='🚫' expand='false'>private</fold> <fold text='🔘' expand='false'>boolean</fold> field3;<fold text='' expand='false'>
            </fold><fold text='' expand='false'><fold text='🛡️' expand='false'>protected</fold> ProtectedArgs(String field1, <fold text='🔢' expand='false'>int</fold> field2, <fold text='🔘' expand='false'>boolean</fold> field3) <fold text='{...}' expand='true'>{
                this.field1 = <fold text='<<' expand='false'>field1</fold>;
                this.field2 = <fold text='<<' expand='false'>field2</fold>;
                this.field3 = <fold text='<<' expand='false'>field3</fold>;
            }</fold></fold>
    ...
    public <fold text='🏛️' expand='false'>class</fold> RequiredArgsConstructorAnnotation <fold text='{...}' expand='true'>{
        ...
        <fold text='@RequiredArgsConstructor(private) p' expand='false'>p</fold>ublic <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> StaticNameArgs <fold text='{...}' expand='true'>{
            ...
            public static StaticNameArgs of(String field1, <fold text='🔢' expand='false'>int</fold> field2, <fold text='🔘' expand='false'>boolean</fold> field3) <fold text='{...}' expand='true'>{<fold text=' ' expand='true'>
                </fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold><fold text='✨' expand='false'>new</fold> StaticNameArgs(field1, field2, field3)<fold text=' ' expand='true'>;</fold><fold text='' expand='true'>
            </fold>}</fold>
        }</fold>
    ...
    <fold text='🏛️' expand='false'>class</fold> SingleField <fold text='{...}' expand='true'>{
        ...
        <fold text='@RequiredArgsConstructor p' expand='false'>p</fold>ublic <fold text='⚡' expand='false'>static</fold> <fold text='🏛️' expand='false'>class</fold> ReqArgs <fold text='{...}' expand='true'>{
            ...
            <fold text='' expand='false'></fold>public ReqArgs(String field1)<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='📍' expand='false'>this</fold>.field1 = <fold text='<<' expand='false'>field1</fold><fold text='' expand='true'>;</fold><fold text=' ' expand='true'><fold text=' }' expand='false'>
            </fold>}</fold></fold>
        }</fold>
    ...
    <fold text='🏛️' expand='false'>class</fold> FieldLevelData <fold text='{...}' expand='true'>{
        ...
        <fold text='🚫' expand='false'>private</fold> String ignored;<fold text='' expand='false'>
            ...
            </fold></fold><fold text='📍' expand='false'>this</fold>.name = <fold text='<<' expand='false'>name</fold><fold text='' expand='true'>;<fold text=' ' expand='true'><fold text=' }' expand='false'></fold>
        </fold>}</fold><fold text='' expand='false'></fold>
    ...
    <fold text='🏛️' expand='false'>class</fold> FieldLevelNotFinalNotValue <fold text='{...}' expand='true'>{
        ...
        public int hashCode()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>Objects.hashCode(name)<fold text=' ' expand='true'>;</fold><fold text=' }' expand='false'><fold text='' expand='true'>
        </fold>}</fold></fold>
    }</fold>
    ...
    <fold text='@Builder c' expand='false'><fold text='🏛️' expand='false'>c</fold>lass</fold> ClassWithBuilder <fold text='{...}' expand='true'>{
        ...
        <fold text='🏛️' expand='false'>class</fold> ClassWithBuilderBuilder <fold text='{...}' expand='true'>{
            ...
            public ClassWithBuilder build()<fold text=' { ' expand='false'> {<fold text=' ' expand='true'>
                </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold><fold text='✨' expand='false'>new</fold> ClassWithBuilder()<fold text=' ' expand='true'>;</fold><fold text='' expand='true'><fold text=' }' expand='false'>
            </fold>}</fold>
        }</fold>
    }</fold>
