...
<fold text='' expand='true'>@SuppressWarnings("ALL")</fold><fold text='' expand='true'>
</fold>public class OverrideHideTestData {
    ...
    public static void main(String[] args) <fold text='{...}' expand='true'>{
        <fold text='val' expand='false'>Runnable</fold> runner = <fold text='run() → { ' expand='false'>new Runnable() {
            <fold text='' expand='true'>@Override</fold><fold text='' expand='true'>
                ...
                </fold><fold text='' expand='false'></fold>System.out.</fold>println(<fold text='"Running in anonymous class"' expand='false'>"Running in anonymous class"</fold>)<fold text='' expand='true'>;</fold><fold text=' ' expand='true'><fold text=' }' expand='false'>
            </fold>}
        }</fold>;
        runner.run();
    ...
    <fold text='@AllArgsConstructor @ToString @EqualsAndHashCode c' expand='false'>c</fold>lass Circle implements Shap<fold text='e(2-calculateArea, calculatePerimeter)' expand='true'>e</fold> <fold text='{...}' expand='true'>{
        ...
        <fold text='' expand='true'>@Override</fold><fold text='' expand='true'>
            ...
            </fold><fold text='' expand='true'></fold>return</fold><fold text='' expand='true'> </fold>Math.PI * radius * radius<fold text='' expand='true'>;</fold><fold text=' ' expand='true'><fold text=' }' expand='false'>
        </fold><fold text='} // overrides from Shape' expand='true'>}</fold></fold>
        ...
        <fold text='' expand='true'>@Override</fold><fold text='' expand='true'>
            ...
            </fold></fold><fold text='' expand='true'>return</fold><fold text='' expand='true'> </fold>"Circle with radius: <fold text='$' expand='false'>" + </fold>radius<fold text='' expand='true'>;</fold><fold text=' ' expand='true'><fold text=' }' expand='false'>
