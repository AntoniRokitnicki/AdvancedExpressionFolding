...
public class IfNullSafeData {
    public void enter(Data data) {
        val threeChains = data?.data1 != null
                && data?.data1 != null
                && data != null
                && data?.data1?.active == true;

        val notChain = data != null && !data.data1.active;
        val chain = data?.data1?.data4 != null;

        if data?.data1?.data2?.data3 != null {
            println("data?.data1?.data2?.data3 != null");
        }
        if data?.data1 != null {
            println("data?.data1 != null");
        }
        if data?.active == true {
