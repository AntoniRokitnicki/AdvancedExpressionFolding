...
public <fold text='🏛️' expand='false'>class</fold> OptionalTestData {
    ...
    public <fold text='💀' expand='false'>void</fold> enter(Optional<Data> opt, Data data, Data dataNull) <fold text='{...}' expand='true'>{
        ...
        o = <fold text='' expand='false'>Optional.ofNullable(</fold>dataNull<fold text='' expand='false'>)</fold><fold text=' ?: ' expand='false'>.orElseGet(<fold text='📍' expand='false'></fold>this</fold>::orElseGetReturn<fold text='' expand='false'>)</fold>;
    ...
    <fold text='🚫' expand='false'>private</fold> Data orElseGetReturn()<fold text=' { ' expand='false'> {
        </fold><fold text='🔙' expand='false'>return</fold> <fold text='🕳️' expand='false'>null</fold>;<fold text=' }' expand='false'>
    }</fold>

    <fold text='🚫' expand='false'>private</fold> Optional<Data> ofNullable(Data data)<fold text=' { ' expand='false'> {
        </fold><fold text='🔙' expand='false'>return</fold> Optional.empty();<fold text=' }' expand='false'>
    }</fold>

    <fold text='🚫' expand='false'>private</fold> <fold text='⚡' expand='false'>static</fold> Data getOutsideData(Data data)<fold text=' { ' expand='false'> {
        </fold><fold text='🔙' expand='false'>return</fold> <fold text='🕳️' expand='false'>null</fold>;<fold text=' }' expand='false'>
    }</fold>
