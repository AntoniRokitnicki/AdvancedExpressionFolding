...
public class NullableAnnotationTestData {
    ...
    public void select([7:"@Nullable"][7:" "]String[7:" "]element,
                       int i,
                       [8:"@NotNull"][8:" "]Object[8:" "]o,
                       [9:"@Nonnull"][9:" "]LocalDate[9:" "]date
                       ) {
    ...
    interface Datable {
        [16:"@Nullable"]
        public Integer[16:" "]select([17:"@Nullable"][17:" "]String[17:" "]element,
                           int i,
                           [18:"@NotNull"][18:" "]Object[18:" "]o,
                           [19:"@Nonnull"][19:" "]LocalDate[19:" "]date
        );
    }
    ...
    public enum FieldFoldingAnnotation {
        ...
        [23:"@Nonnull"]
        public static int[23:" "]select([24:"@Nullable"][24:" "]String[24:" "]element,
                                 int i,
                                 [25:"@NotNull"][25:" "]Object[25:" "]o,
                                 [26:"@Nonnull"][26:" "]LocalDate[26:" "]date
        ) {
            return 1;
        }
    ...
    [33:"c"]lass GetterNullable {
        ...
        public NullableAnnotationTestData[34:" "]getGetterNullable() {
