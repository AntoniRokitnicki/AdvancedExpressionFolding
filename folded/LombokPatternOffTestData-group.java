...
public class LombokPatternOffTestData {
    ...
    public LombokPatternOffTestData getData() {
        return data;
    }

    public void setData(LombokPatternOffTestData data) {
        this.data = data;
    }
    ...
    public Optional<LombokPatternOffTestData> asOptional() {
    ...
    public class DataFull {
        ...
        public class DataWithoutToString {
            ...
            public boolean equals(Object o) {
                if (this == o) return true;
                if (!(o instanceof LombokPatternOffTestData.DataFull)) return false;
                LombokPatternOffTestData.DataFull dataFull = (LombokPatternOffTestData.DataFull) o;
                return new EqualsBuilder().append(ok, dataFull.ok).append(data, dataFull.data).isEquals();
            }
