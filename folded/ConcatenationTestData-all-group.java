...
public class ConcatenationTestData {
    public static void main(String[] args) {
        ...
        streamToList = list.stream()[118:".map("][120:"String::toUpperCase"][118:")"][117:".collect(Collectors."]toList()[117:")"];
        [126:"System.out."]println(streamToList);
        streamToList = list.stream()[128:".map("][130:"String::toUpperCase"][128:")"][127:".collect(Collectors."]toList()[127:")"];
        [136:"System.out."]println(streamToList);
        streamToList = list.stream()[138:".map("][140:"String::toUpperCase"][138:")"][137:".collect(Collectors."]toList()[137:")"];
        [146:"System.out."]println(streamToList);
        streamToList = list.stream()[148:".map("][150:"String::toUpperCase"][148:")"][147:".collect(Collectors."]toList()[147:")"];
        [156:"System.out."]println(streamToList);
        streamToList = list.stream()[158:".map("][160:"String::toUpperCase"][158:")"][157:".collect(Collectors."]toList()[157:")"];
        [166:"System.out."]println(streamToList);
        streamToList = list.stream()[168:".map("][170:"String::toUpperCase"][168:")"][167:".collect(Collectors."]toList()[167:")"];
        [176:"System.out."]println(streamToList);
        streamToList = list.stream()[178:".map("][180:"String::toUpperCase"][178:")"][177:".collect(Collectors."]toList()[177:")"];
        [186:"System.out."]println(streamToList);
        streamToList = list.stream()[188:".map("][190:"String::toUpperCase"][188:")"][187:".collect(Collectors."]toList()[187:")"];
        [196:"System.out."]println(streamToList);
        streamToList = list.stream()[198:".map("][200:"String::toUpperCase"][198:")"][197:".collect(Collectors."]toList()[197:")"];
        [206:"System.out."]println(streamToList);
        streamToList = list.stream()[208:".map("][210:"String::toUpperCase"][208:")"][207:".collect(Collectors."]toList()[207:")"];
