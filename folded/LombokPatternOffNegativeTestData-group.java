...
[0:"p"]ublic class LombokPatternOffNegativeTestData {[0:"
    ...
    [0:"p"]ublic class LombokSetters {
        ...
        public class LombokSettersPartial {
            [0:"L"]ombokPatternOffNegativeTestData data;
            boolean ok;[0:"
    ...
    public class NoArgsConstructorAnnotation {
        ...
        [0:"p"]ublic class NoArgsConstructorSuperBefore {[0:"
            "][0:"public NoArgsConstructorSuperBefore() {
                // comment
                super();
            }"]
        }
        [0:"p"]ublic class NoArgsConstructorSuperAfter {[0:"
            "][0:"public NoArgsConstructorSuperAfter() {
                super();
                // comment
            }"]
        }

        [0:"p"]ublic class ProtectedNoArgsConstructorSuperAfter {[0:"
            "][0:"protected ProtectedNoArgsConstructorSuperAfter() {
                // comment
            }"]
        }
