...
public class LocalDateTestData {
    public void main(String[] args) {
        ...
        boolean isBefore = d1[0:".isBefore("][4:".isBefore("]d2[0:")"][4:")"];
        boolean isAfter = d1[1:".isAfter("][5:".isAfter("]d2[1:")"][5:")"];
        boolean d2SmallerOrEqualD1 = [2:"!"][6:"!"]d1[2:".isBefore("][6:".isBefore("]d2[2:")"][6:")"];;
        boolean d1SmallerOrEqualD2 = [3:"!"][7:"!"]d1[3:".isAfter("][7:".isAfter("]d2[3:")"][7:")"];
    ...
    public class CustomClass2  {
        ...
        public boolean isBefore(CustomClass2 other) {
            return this.minguoDate[72:".isBefore("][73:".isBefore("]other.minguoDate[72:")"][73:")"];
        }

        public boolean isAfter(CustomClass2 other) {
            return this.minguoDate[74:".isAfter("][75:".isAfter("]other.minguoDate[74:")"][75:")"];
        }
    }
