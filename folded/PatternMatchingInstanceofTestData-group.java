...
public class PatternMatchingInstanceofTestData {
    ...
    public void main(String arg, int i, Object o, Data data) {
        ...
        if (o instanceof Data[2:")"] {
            [2:"Data d = (Data) o;"][2:"\n            "]System.out.println(d.getValue());
        }

        if (o instanceof int[][3:")"] {
            [3:"int[] arr = (int[]) o;"][3:"\n            "]System.out.println(arr.length);
        }


        if (o instanceof DayOfWeek[4:")"] {
            [4:"DayOfWeek day = (DayOfWeek) o;"][4:"\n            "]System.out.println(day.name());
        }
    }
    ...
    static class TypeMatchingTest {
        public void positiveTest(Object o) {
            if (o instanceof String[5:")"] {
                [5:"String s = (String) o;"][5:"\n                "]System.out.println(s.length());
            }
        }
    ...
    static class VariableUsageTest {
        public void positiveTest(Object o) {
            if (o instanceof String[6:")"] {
                [6:"String s = (String) o;"][6:"\n                "]System.out.println(s.length());
            }
        }
    ...
    static class SimpleAssignmentTest {
        public void positiveTest(Object o) {
            if (o instanceof String[7:")"] {
                [7:"String s = (String) o;"][7:"\n                "]System.out.println(s.length());
            }
        }
    ...
    static class CastAssignmentTest {
        public void positiveTest(Object o) {
            if (o instanceof String[8:")"] {
                [8:"String s = (String) o;"][8:"\n                "]System.out.println(s.length());
            }
        }
