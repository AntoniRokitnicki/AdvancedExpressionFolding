...
public class ConcatenationTestData {
    public static void main(String[] args) {
        ...
        streamToList = list[100:".stream()."]map([101:"String::toUpperCase"][99:")"][98:".collect(Collectors."]toList()[98:")"];
        System.out.println(streamToList);
        streamToList = list[109:".stream()."]map([110:"String::toUpperCase"][108:")"][107:".collect(Collectors."]toList()[107:")"];
        System.out.println(streamToList);
        streamToList = list[118:".stream()."]map([119:"String::toUpperCase"][117:")"][116:".collect(Collectors."]toList()[116:")"];
        System.out.println(streamToList);
        streamToList = list[127:".stream()."]map([128:"String::toUpperCase"][126:")"][125:".collect(Collectors."]toList()[125:")"];
        System.out.println(streamToList);
        streamToList = list[136:".stream()."]map([137:"String::toUpperCase"][135:")"][134:".collect(Collectors."]toList()[134:")"];
        System.out.println(streamToList);
        streamToList = list[145:".stream()."]map([146:"String::toUpperCase"][144:")"][143:".collect(Collectors."]toList()[143:")"];
        System.out.println(streamToList);
        streamToList = list[154:".stream()."]map([155:"String::toUpperCase"][153:")"][152:".collect(Collectors."]toList()[152:")"];
        System.out.println(streamToList);
        streamToList = list[163:".stream()."]map([164:"String::toUpperCase"][162:")"][161:".collect(Collectors."]toList()[161:")"];
        System.out.println(streamToList);
        streamToList = list[172:".stream()."]map([173:"String::toUpperCase"][171:")"][170:".collect(Collectors."]toList()[170:")"];
        System.out.println(streamToList);
        streamToList = list[181:".stream()."]map([182:"String::toUpperCase"][180:")"][179:".collect(Collectors."]toList()[179:")"];
        System.out.println(streamToList);
