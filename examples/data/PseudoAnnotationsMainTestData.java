...
public class PseudoAnnotationsMainTestData {
    ...
    public PseudoAnnotationsMainTestData() {
    }

    public PseudoAnnotationsMainTestData(int param) {
    }

    public PseudoAnnotationsMainTestData(String name, int value) {
    }
