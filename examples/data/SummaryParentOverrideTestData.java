...
public class SummaryParentOverrideTestData extends ParentClass implements FirstInterface, SecondInterface {
    ...
    public void grandparentMethod() {
        System.out.println("Overridden Grandparent Method in SummaryParentOverrideTestData");
    }
    ...
    public static void main(String[] args) {
        SummaryParentOverrideTestData testData = new SummaryParentOverrideTestData();
        testData.interfaceMethodOne();
        testData.interfaceMethodTwo();
        testData.sharedMethod();
        testData.grandparentMethod();
        testData.additionalMethodOne();
        testData.additionalMethodTwo();
        testData.additionalMethodThree();
    }
}
